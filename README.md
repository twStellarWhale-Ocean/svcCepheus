...
```bash
helm install cepheus oci://ghcr.io/twstellerwhale-ocean2/solcepheus-chart --version 0.1.12 \
...
```bash
helm install cepheus-core   oci://ghcr.io/twstellerwhale-ocean2/solcepheus-syscepheus-chart   --version 0.28.0
...
> |---|---|---|---|
> | 一鍵 umbrella | `solcepheus-chart` | 0.1.12 | 0.28.0 |
> | 核心（零領域包） | `solcepheus-syscepheus-chart` | 0.28.0 | 0.28.0 |
...
```bash
helm upgrade cepheus oci://ghcr.io/twstellerwhale-ocean2/solcepheus-chart --version 0.1.12 \
