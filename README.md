...
```bash
helm install cepheus oci://ghcr.io/twstellerwhale-ocean2/solcepheus-chart --version 0.1.11 \
...
```bash
helm install cepheus-core   oci://ghcr.io/twstellerwhale-ocean2/solcepheus-syscepheus-chart   --version 0.27.0
...
> |---|---|---|---|
> | 一鍵 umbrella | `solcepheus-chart` | 0.1.11 | 0.27.0 |
> | 核心（零領域包） | `solcepheus-syscepheus-chart` | 0.27.0 | 0.27.0 |
...
```bash
helm upgrade cepheus oci://ghcr.io/twstellerwhale-ocean2/solcepheus-chart --version 0.1.11 \
