...
```bash
helm install cepheus oci://ghcr.io/twstellerwhale-ocean2/solcepheus-chart --version 0.1.18 \
...
```bash
helm install cepheus-core   oci://ghcr.io/twstellerwhale-ocean2/solcepheus-syscepheus-chart   --version 0.32.0
...
> |---|---|---|---|
> | 一鍵 umbrella | `solcepheus-chart` | 0.1.18 | 0.32.0 |
> | 核心（零領域包） | `solcepheus-syscepheus-chart` | 0.32.0 | 0.32.0 |
...
```bash
helm upgrade cepheus oci://ghcr.io/twstellerwhale-ocean2/solcepheus-chart --version 0.1.18 \
