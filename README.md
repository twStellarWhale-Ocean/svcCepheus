...
* 本手冊的代號：`privOpr`＝一件可在畫面上操作完成的工作；`prsnOpr`＝某個職位的個人作業程序；`teamOpr`／`orgOpr`＝組、組織兩層的作業程序；`orgOpr#B`（井號後只有一個字母）＝第一層作業，也就是一個業務領域；`refPrivOpr`＝引用範本庫的標準工作。
...
| 公司職務 | 系統席（運輸調度辦公室） | 先學這幾頁 | 上手要點 |
| --- | --- | --- | --- |
| 業務（陳小姐） | 調度客戶聯絡席、調度內部管理席、調度派車管制席 | 客戶資料頁、車輛資料頁（含車輛不可用時段）、駕駛資料頁、叫車頁、派車頁；另用紀錄匯出頁留紙本 | 客戶來電在叫車頁受理；到派車頁替叫車單配車與駕駛，可取 AI 建議，存成草擬送核（不能核定自己安排的單）；待處理事項也在派車頁：客戶取消或改單後，派車單不會自動撤銷，要在這裡撤銷再重新安排；駕駛收訊不良時代登回報；完成回報後回叫車頁結案 |
| 負責人（林經理） | 調度主管席 | 派車頁、駕駛資料頁 | 派車頁逐張核定或退回，核定後系統自動送給駕駛；駕駛請假在駕駛資料頁核定；不能核定自己的申請 |
| 駕駛（王大明、李小華、張志強） | 調度車輛駕駛席 | 通用登入頁、駕駛接辦頁、駕駛回報頁（皆手機） | 首次登入改密碼；系統不主動通知，請定期開駕駛接辦頁查看；只看得到指名給自己的派車單，接辦或附原因婉拒；出車後回報進度、完成或異常；請假在接辦頁自己申請 |

* 一人可兼多席，登入後左欄只列所屬單位之頁；看不到某個按鈕＝所在席沒有該權限，請洽系統管理員調整席指派。
<!-- hand:roles:end -->
